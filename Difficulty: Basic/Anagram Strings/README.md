<h2><a href="https://www.geeksforgeeks.org/problems/java-anagram-strings3549/1">Anagram Strings</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given two strings S1 and S2 . Return "1" if both strings are anagrams otherwise return "0" .</span></p>
...
<p>&nbsp;</p></div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Strings</code>&nbsp;<code>Java</code>&nbsp;